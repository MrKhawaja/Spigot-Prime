...
public class SQL {
    ...
    public static boolean tableExists(String table) {
        try {
            Connection connection = xyz.alveehawak.prime.mysql.database.MySQL.getConnection();
            if (connection == null) {
                return false;
            }
    ...
    public static boolean insertData(String columns, String values, String table) {
        return xyz.alveehawak.prime.mysql.database.MySQL.update("INSERT INTO " + table + " (" + columns + ") VALUES (" + values + ");");
    }
    ...
    public static boolean deleteData(String column, String logic_gate, String data, String table) {
        ...
        return xyz.alveehawak.prime.mysql.database.MySQL.update("DELETE FROM " + table + " WHERE " + column + logic_gate + data + ";");
    }
    ...
    public static boolean exists(String column, String data, String table) {
        ...
        try {
            ResultSet rs = xyz.alveehawak.prime.mysql.database.MySQL.query("SELECT * FROM " + table + " WHERE " + column + "=" + data + ";");
            if (rs.next()) {
                return true;
            }
        } catch (Exception var4) {
    ...
    public static boolean deleteTable(String table) {
        return xyz.alveehawak.prime.mysql.database.MySQL.update("DROP TABLE " + table + ";");
    }

    public static boolean truncateTable(String table) {
        return xyz.alveehawak.prime.mysql.database.MySQL.update("TRUNCATE TABLE " + table + ";");
    }

    public static boolean createTable(String table, String columns) {
        return xyz.alveehawak.prime.mysql.database.MySQL.update("CREATE TABLE IF NOT EXISTS " + table + " (" + columns + ");");
    }
    ...
    public static boolean upsert(String selected, Object object, String column, String data, String table) {
        ...
        try {
            ResultSet rs = xyz.alveehawak.prime.mysql.database.MySQL.query("SELECT * FROM " + table + " WHERE " + column + "=" + data + ";");
            if (rs.next()) {
                xyz.alveehawak.prime.mysql.database.MySQL.update("UPDATE " + table + " SET " + selected + "=" + object + " WHERE " + column + "=" + data + ";");
            } else {
    ...
    public static boolean set(String selected, Object object, String column, String logic_gate, String data, String table) {
        ...
        return xyz.alveehawak.prime.mysql.database.MySQL.update("UPDATE " + table + " SET " + selected + "=" + object + " WHERE " + column + logic_gate + data + ";");
    }
    ...
    public static boolean set(String selected, Object object, String[] where_arguments, String table) {
        ...
        if (arguments.length() <= 5) {
            ...
            return xyz.alveehawak.prime.mysql.database.MySQL.update("UPDATE " + table + " SET " + selected + "=" + object + " WHERE " + arguments + ";");
        }
    }
    ...
    public static Object get(String selected, String[] where_arguments, String table) {
        ...
        if (arguments.length() <= 5) {
            ...
            try {
                ResultSet rs = xyz.alveehawak.prime.mysql.database.MySQL.query("SELECT * FROM " + table + " WHERE " + arguments + ";");
                if (rs.next()) {
    ...
    public static Object get(String selected, String column, String logic_gate, String data, String table) {
        ...
        try {
            ResultSet rs = xyz.alveehawak.prime.mysql.database.MySQL.query("SELECT * FROM " + table + " WHERE " + column + logic_gate + data + ";");
            if (rs.next()) {
                return rs.getObject(selected);
            }
        } catch (Exception var6) {
